...
public class AutoAlignLeftLV4Back extends Command {
    ...
    public AutoAlignLeftLV4Back(CommandSwerveDrivetrain drivetrain, Limelight limelight) {
    ...
    public void initialize() {
        ...
        LimelightHelpers.setPipelineIndex("limelight-stwo", 1);
