...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        NamedCommands.registerCommand("L3 Algee", new LV3Algee(s_ArmRot, s_ArmExtend, s_WristRot, s_IntakeJaws));
        NamedCommands.registerCommand("Barge", new AutoBarge(s_ArmRot, s_ArmExtend, s_WristRot, s_IntakeJaws, s_IntakeMotorOne, s_IntakeMotorTwo));
    ...
    // Note that X is defined as forward according to WPILib convention,
        ...
        DriveStick.x().onTrue(new Stash(s_ArmRot, s_ArmExtend, s_WristRot));
        ...
        CopilotStick.rightBumper().and(CopilotStick.x()).onTrue(new ReefLV4Front(s_ArmRot, s_ArmExtend, s_WristRot));
        ...
        CopilotStick.rightBumper().and(CopilotStick.y()).onTrue(new LV3Algee(s_ArmRot, s_ArmExtend, s_WristRot, s_IntakeJaws));
